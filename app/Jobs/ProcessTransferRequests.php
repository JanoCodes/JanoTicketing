...
class ProcessTransferRequests implements ShouldQueue
{
     ...
     *
     * @param \Jano\Contracts\TransferRequestContract $transferRequestContract
     * @param \Jano\Contracts\AttendeeContract $attendeeContract
     */
    public function __construct(TransferRequestContract $transferRequestContract, AttendeeContract $attendeeContract)
    {

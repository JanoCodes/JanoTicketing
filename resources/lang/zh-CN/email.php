...
return [
    ...
    'bank_payment_message' => 'Please transfer the balance of :balance to the following bank account within :deadline working days. Please ensure that you use the payment reference **exactly as shown**.',

...
<div id="data">
    <div class="actions grid-x">
        <div class="small-12 medium-6 large-8 cell">
            <a class="button hollow" href="{{ route('backend.requests.create') }}">
    ...
    <vuetable ref="vuetable" api-url="{{ route('backend.requests.index') }}" :fields="fields" :append-params="param"
        ...
        const vm = new Vue({
            ...
            data: {
                ...
                fields: [
                    ...
                    {
                        name: 'preferred_ticket.name',
                        sortField: 'preferred_ticket.name',

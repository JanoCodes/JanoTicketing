...
namespace Jano\Modules\TransferRequest\Notifications;
...
class TransferRequestCreated extends Notification
{
    use Queueable;
     ...
     */
    public function __construct(Account $account, TransferRequest $transfer)
    {

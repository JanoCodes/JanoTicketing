...
namespace Jano\Modules\TicketRequest\Http\Controllers;
...
class TicketRequestController extends Controller
{
     ...
     *
     * @param \Jano\Modules\TicketRequest\Contracts\RequestContract
     */
    public function __construct(RequestContract $contract)
    {
    ...
    {
        return view('ticket-request::create');
    }
    ...
    {
        $this->authorize('create', TicketRequest::class);

        $this->storeValidator($request->all());
        $ticket_request = $this->contract->store($request->user(), $request->all());

        return view('ticket-request::store', [
    ...
    public function edit(TicketRequest $request)
    {
        ...
        return view('ticket-request::edit', [

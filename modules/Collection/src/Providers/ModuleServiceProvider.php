...
namespace Jano\Modules\Collection\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    protected $implementations = [
        \Jano\Modules\Collection\Contracts\CollectionContract::class =>
            \Jano\Modules\Collection\Repositories\CollectionRepository::class
    ];
